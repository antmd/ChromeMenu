...
#import "CMUnderlyingView.h"

@interface CMUnderlyingView()
{
...
@implementation CMUnderlyingView
...
@interface CMUnderlyingViewVibrant()
{
	NSArray *_borderRadiuses;
}
...
@implementation CMUnderlyingViewVibrant
